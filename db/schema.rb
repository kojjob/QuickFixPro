...
ActiveRecord::Schema[8.0].define(version: 2025_09_11_094514) do
  ...
  create_table "monitoring_alerts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["resolved", "severity"], name: "index_monitoring_alerts_on_resolved_and_severity"
    t.index ["website_id", "created_at"], name: "index_monitoring_alerts_on_website_id_and_created_at"
